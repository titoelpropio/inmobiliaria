    ...
    <body>
        ...
        <div style="min-height: 50px;">
            ...
            <div id="slider1_container" style="visibility: hidden; position: relative; margin: 0 auto;
                ...
                <div u="slides" style="position: absolute; left: 0px; top: 0px; width: 1300px; height: 500px; overflow: hidden;">
                    <div>
                        <img u="image" src2="{{asset("/images/1920/red.jpg")}}" />
                    </div>
                    <div>
                        <img u="image" src2="{{asset("/images/1920/red.jpg")}}" />
                    </div>
                ...
                <style>
                    ...
                    */
                    ...
                    .jssorb21 div, .jssorb21 div:hover, .jssorb21 .av {
                        ...
                        color: white;
                        font-size: 12px;
                        background: url(http://localhost:8080/inmobiliaria/public/images/b21.png) no-repeat;
                        overflow: hidden;
                        cursor: pointer;
                    }
                ...
                <style>
                    ...
                    */
                    .jssora21l, .jssora21r {
                        ...
                        height: 55px;
                        cursor: pointer;
                        background: url(http://localhost:8080/inmobiliaria/public/images/a21.png) center center no-repeat;
                        overflow: hidden;
                    }
        ...
        <div class="container marketing">
                    ...
                    <div id="row" >
                        <!--                <div class="row" >
                                            ...
                                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 "  >
                                                <img src={{asset("images/inmobiliaria.jpg")}}  style="height: 20%; width: 20%"/>
                                                <button class="btn btn-default   btn-responsive pull-right  "><i class="fa fa-user" aria-hidden="true"></i>INGRESAR AL SISTEMA</button>
                                            </div>
                        ...
                        <!--                <nav role="navigation" class="navbar navbar-inverse navbar-fixed">
                                            ...
                                            <div id="navbarCollapse" class="collapse navbar-collapse">
                                                ...
                                                <ul class="nav navbar-nav navbar-right">
                                                    <li><button class="btn btn-primary   btn-responsive pull-right  ">Publica tu Propiedad</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </nav>-->
            ...
            <footer>
                ...
                <p>&copy; MODESTO SALDAÑA 2009 - 2017. &middot; <a href="#">Privacy</a> &middot; </p>
            </footer>
