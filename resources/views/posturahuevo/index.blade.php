        ...
        <div class="table-responsive">	
            ...
            <table border=1 cellpadding=0 cellspacing=0 class="table-striped  table-condensed table-hover" style="width: 100%;height: 350px">
                ...
                <tr height=28 style='height:21.0pt'>
                    ...
                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[0]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2% title="1">GALPON 1</td>


                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[1]}}</td>
                    <td colspan=3 class=xl91 align=center style='border-top:none;border-left:none' width=2%>GALPON 2</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[2]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2%>GALPON 3</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[3]}}</td>
                    <td colspan=3 class=xl91 align=center style='border-top:none;border-left:none' width=2%>GALPON 4</td>


                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[4]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2%>GALPON 5</td>


                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[5]}}</td>
                    <td colspan=3 class=xl91 align=center style='border-top:none;border-left:none' width=2%>GALPON 6</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[6]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2%>GALPON 7</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[7]}}</td>
                ...
                <tr height=20 style='height:15.0pt'>
                    ...
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[0],['id'=>'G5g1'])!!}</font></td>
                    ...
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[1],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(2)'  id="btnalimentog2" >Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[2],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 align=center class=xl103 align=center style='border-top:none;border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal'  id="btnalimentog3" onclick='obtenerdatos(3)'>Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[3],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'> <button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(4)' id="btnalimentog4" >Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[4],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl99 align=center style='border-top:none;border-left:none'> <button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(5)' id="btnalimentog5" >Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[5],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'> <button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(6)' id="btnalimentog6" >Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[6],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-top:none;border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(7)' id="btnalimentog7" >Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[7],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(8)' id="btnalimentog8" >Alimento</button></td>
                </tr>
            </table>
            ...
            <table border=1 cellpadding=0 cellspacing=0 class="table-striped  table-condensed table-hover" style="width: 100%;height: 350px">
                ...
                <tr height=28 style='height:21.0pt'>
                    <td height=57 class=xl78 style='height:42.75pt'>FECHA</td>
                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[8]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2% title="1">GALPON 9</td>


                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[9]}}</td>
                    <td colspan=3 class=xl91 align=center style='border-top:none;border-left:none' width=2%>GALPON 10</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[10]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2%>GALPON 11</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[11]}}</td>
                    <td colspan=3 class=xl91 align=center style='border-top:none;border-left:none' width=2%>GALPON 12</td>


                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[12]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2%>GALPON 13</td>


                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[13]}}</td>
                    <td colspan=3 class=xl91 align=center style='border-top:none;border-left:none' width=2%>GALPON 14</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[14]}}</td>
                    <td colspan=3 class=xl87 align=center style='border-top:none;border-left:none' width=2%>GALPON 15</td>

                    <td colspan=3 height=29 align=center class=xl85 style='height:21.75pt;border-top:none'>{{$tipo[15]}}</td>
                ...
                <tr height=20 style='height:15.0pt'>
                    <td height=20 class=xl96 style='height:15.0pt'>{!!Form::label($fecha,null,['id'=>'fecha'])!!}</td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[8],['id'=>'G5g1'])!!}</font></td>
                    ...
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[9],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(10)'  id="btnalimentog10">Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[10],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 align=center class=xl103 align=center style='border-top:none;border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(11)'  id="btnalimentog11">Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[11],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'> <button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(12)'  id="btnalimentog12">Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[12],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl99 align=center style='border-top:none;border-left:none'> <button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(13)'  id="btnalimentog13">Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[13],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'> <button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(14)'  id="btnalimentog14">Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[14],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-top:none;border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(15)'  id="btnalimentog15">Alimento</button></td>
                    <td colspan=3 align=center style='border-top:none'><font size=3>{!!Form::label(null,$cantidadc[15],['id'=>'G5g1'])!!}</font></td>
                    <td colspan=3 class=xl103 align=center style='border-left:none'><button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='obtenerdatos(16)' id="btnalimentog16">Alimento</button></td>
                </tr>
            </table>
        </div>
    </div>
